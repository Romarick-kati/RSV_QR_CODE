...
export default function EventDetail() {
  ...
  //
  // IMPORTANT: this hook must stay above the early `return`s below — React
  // requires every hook to run on every render, in the same order. Having
  // it after the loading/notFound returns meant it wasn't registered on
  // the first (loading) render but was on the next one, which crashes
